...
from data import COCODetection, obj365Detection, VOCDetection, detection_collate, preproc
...
def get_dataloader(cfg, dataset, setname='train_sets'):
    ...
    Dataloader_function = {'VOC': VOCDetection, 'COCO':COCODetection, 'objects365':obj365Detection}
    _Dataloader_function = Dataloader_function[dataset]
    if setname == 'train_sets':
        dataset = _Dataloader_function(cfg.COCOroot if dataset == 'COCO' else cfg.VOCroot if dataset =='VOC' else cfg.objects365root,
